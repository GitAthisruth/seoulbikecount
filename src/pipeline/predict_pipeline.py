...
# root_directory = "D:\Expertzlab\seoulbikecount"
# model_path = os.path.join(root_directory, "artifacts", "model.pkl")
# preprocessor_path = os.path.join(root_directory, "artifacts", "preprocessor.pkl")
# model=load_object(file_path=model_path)
# preprocessor=load_object(file_path=preprocessor_path)
